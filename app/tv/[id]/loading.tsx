  ...
  return (
    <main>
      ...
      <section className="px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-4 h-6 w-24 rounded bg-white/[0.05] skeleton" />
        <div className="mx-auto max-w-3xl space-y-2">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="flex gap-4 rounded-xl bg-white/[0.02] p-3">
              <div className="aspect-video w-[140px] flex-shrink-0 rounded-lg bg-white/[0.05] skeleton sm:w-[180px]" />
              <div className="flex flex-1 flex-col justify-center py-1">
                <div className="h-4 w-3/4 rounded bg-white/[0.05] skeleton" />
                <div className="mt-2 h-3 w-full rounded bg-white/[0.05] skeleton" />
                <div className="mt-1 h-3 w-1/2 rounded bg-white/[0.05] skeleton" />
              </div>
            </div>
          ))}
        </div>

...
import { X, Monitor, MessageCircle, Send } from "lucide-react"
  ...
  return (
    <div className="dialog-backdrop" onClick={onClose}>
      <div className="dialog account-dialog" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="account-dialog-sub">Manage your preferences</p>
        ...
        <div className="px-5 pb-2">
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              <strong className="text-sm text-white block">Guest</strong>
              <small className="text-[10px] text-muted font-mono">Not signed in</small>
            </div>
          </div>
            ...
            <div className="flex gap-2">
              {(["subtle", "standard", "vivid"] as const).map((a) => (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-full text-[11px] font-grotesk border ${
                    settings.ambience === a
                      ? "bg-paper text-black border-paper"
                      : "border-white/14 text-aaa bg-transparent"
                  }`}
                >
                  {a}
                </button>
          ...
          <div className="settings-row">
            ...
            <button
              type="button"
              className={`toggle-track ${settings.spoilerProtection ? "active" : ""}`}
          ...
          <div className="settings-row">
            ...
            <button
              type="button"
              className={`toggle-track ${settings.autoplayTrailers ? "active" : ""}`}
